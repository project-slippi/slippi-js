...
[![Build Status](https://github.com/project-slippi/slp-parser-js/workflows/build/badge.svg)](https://github.com/project-slippi/slp-parser-js/actions?workflow=build)
