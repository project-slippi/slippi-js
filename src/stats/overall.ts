...
function getOpeningRatio(conversionsByPlayerByOpening: any, playerIndex: number, opponentIndex: number, type: string): RatioType {
...
// FIXME: Stop using any here. The type is actually one of those wacky custom objects generated by lodash
function getBeneficialTradeRatio(conversionsByPlayerByOpening: any, playerIndex: number, opponentIndex: number): RatioType {
